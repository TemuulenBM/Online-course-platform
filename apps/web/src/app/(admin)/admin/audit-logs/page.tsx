...
function AuditLogTable({
  ...
  if (logs.length === 0) {
    return (
      <div className="bg-white rounded-2xl border border-primary/5 shadow-sm py-16 text-center">
...
function AuditLogTimeline({ logs }: { logs: AuditLogEntry[] }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-primary/5 shadow-sm p-8">
