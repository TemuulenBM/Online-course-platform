  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
      ...
      <div className="flex flex-col items-end gap-2">
        ...
        {/* Keyboard shortcuts hint — video хичээлд л харагдана */}
        {contentType === 'video' && (
          <div className="flex items-center gap-1.5 flex-wrap justify-end">
            {(
              ...
              <span key={key} className="inline-flex items-center gap-1 text-[10px] text-slate-400">
                <kbd className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-mono text-[9px]">
                  {key}
                </kbd>
                {label}
              </span>
